...
if __name__ == '__main__':
    ...
    parser.add_argument('--labeled_examples', default=13448, type=int)
    ...
    parser.add_argument('--semi_n_th', type=float, default=0.0,
    ...
    if args.architecture == "segformer":
        config = json.load(open("PV-S3/main/configs/config_segformer.json"))
    else:
        config = json.load(open("PV-S3/main/configs/config_deeplab_v3+.json"))
